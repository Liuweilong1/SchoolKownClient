package com.example.schoolkownclient.recipe.view;
...
import com.example.schoolkownclient.recipe.adapter.DateAdapter;
import com.example.schoolkownclient.recipe.bean.DateEntity;
import com.example.schoolkownclient.recipe.utils.DataUtils;
...
public class DataView extends LinearLayout implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private void init() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.recipe_view_data,null,false);
