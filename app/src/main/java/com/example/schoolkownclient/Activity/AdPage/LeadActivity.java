...
import com.example.schoolkownclient.Activity.ParentMainActivity;
...
//下边
        ...
        connectedDeviceView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(LeadActivity.this,"欢迎您点击",Toast.LENGTH_LONG).show();
                Intent intent = new Intent(LeadActivity.this, ParentMainActivity.class);
